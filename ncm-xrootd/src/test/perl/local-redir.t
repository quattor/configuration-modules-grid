...
ok(defined($fh), REDIR_CONF_FILE." was opened");
is("$fh", REDIR_EXPECTED_CONF_2, REDIR_CONF_FILE." has expected contents");
$fh->close();
...
$fh = get_file(REDIR_CONF_FILE);
ok(defined($fh), REDIR_CONF_FILE." was opened");
is("$fh", REDIR_EXPECTED_CONF_2."#".FED_REDIRECT_EXPECTED, REDIR_CONF_FILE." has expected contents");
$fh->close();
