...
my %redir_config_rules = (
    "all.sitename"          => "siteName:GLOBAL;" . LINE_FORMAT_KW_VAL,
    "dpmhost"               => "dpmHost:dpm;" . LINE_FORMAT_KW_VAL_SET . ';:' . (LINE_OPT_SEP_EQUAL | LINE_OPT_SEP_SPACE_AROUND),
    ...
    "DPM_CONRETRY"    => "dpmConnectionRetry:dpm;" . LINE_FORMAT_KW_VAL_SETENV . ';:' . (LINE_OPT_SEP_EQUAL | LINE_OPT_SEP_SPACE_AROUND),
    "DPM_HOST"        => "dpmHost:dpm;" . LINE_FORMAT_KW_VAL_SETENV . ';:' . (LINE_OPT_SEP_EQUAL | LINE_OPT_SEP_SPACE_AROUND),
    "DPNS_CONRETRY"   => "dpnsConnectionRetry:dpm;" . LINE_FORMAT_KW_VAL_SETENV . ';:' . (LINE_OPT_SEP_EQUAL | LINE_OPT_SEP_SPACE_AROUND),
    "DPNS_HOST"       => "dpnsHost:dpm;" . LINE_FORMAT_KW_VAL_SETENV . ';:' . (LINE_OPT_SEP_EQUAL | LINE_OPT_SEP_SPACE_AROUND),
    "TTOKENAUTHZ_AUTHORIZATIONFILE" => "authzConf:tokenAuthz;" . LINE_FORMAT_KW_VAL_SETENV . ';:' . (LINE_OPT_SEP_EQUAL | LINE_OPT_SEP_SPACE_AROUND),
);
...
my %fedredir_config_rules = (
    ...
    "xrootfedcmsdmanager"   => "federationCmsdManager:fedparams;" . LINE_FORMAT_KW_VAL_SET . ';:' . (LINE_OPT_SEP_EQUAL | LINE_OPT_SEP_SPACE_AROUND),
    "xrootfedlport"         => "localPort:fedparams;" . LINE_FORMAT_KW_VAL_SET . ';:' . (LINE_OPT_SEP_EQUAL | LINE_OPT_SEP_SPACE_AROUND),
    ...
    "CSEC_MECH"             => "lfcHost:fedparams->lfcSecurityMechanism:fedparams;" . LINE_FORMAT_KW_VAL_SETENV . ';:' .
                                                                                  (LINE_OPT_SEP_EQUAL | LINE_OPT_SEP_SPACE_AROUND),
    "DPM_CONRETRY"    => "dpmConnectionRetry:dpm;" . LINE_FORMAT_KW_VAL_SETENV . ';:' . (LINE_OPT_SEP_EQUAL | LINE_OPT_SEP_SPACE_AROUND),
    "DPM_HOST"        => "dpmHost:dpm;" . LINE_FORMAT_KW_VAL_SETENV . ';:' . (LINE_OPT_SEP_EQUAL | LINE_OPT_SEP_SPACE_AROUND),
    "DPNS_CONRETRY"   => "dpnsConnectionRetry:dpm;" . LINE_FORMAT_KW_VAL_SETENV . ';:' . (LINE_OPT_SEP_EQUAL | LINE_OPT_SEP_SPACE_AROUND),
    "DPNS_HOST"       => "dpnsHost:dpm;" . LINE_FORMAT_KW_VAL_SETENV . ';:' . (LINE_OPT_SEP_EQUAL | LINE_OPT_SEP_SPACE_AROUND),
    ...
    "LFC_CONRETRY"          => "lfcHost:fedparams->lfcConnectionRetry:fedparams;" . LINE_FORMAT_KW_VAL_SETENV . ';:' .
                                                                                        (LINE_OPT_SEP_EQUAL | LINE_OPT_SEP_SPACE_AROUND),
    "LFC_HOST"              => "lfcHost:fedparams;" . LINE_FORMAT_KW_VAL_SETENV . ';:' . (LINE_OPT_SEP_EQUAL | LINE_OPT_SEP_SPACE_AROUND),
    "X509_USER_PROXY"       => "proxyLocation:fedparams;" . LINE_FORMAT_KW_VAL_SETENV . ';:' . (LINE_OPT_SEP_EQUAL | LINE_OPT_SEP_SPACE_AROUND),
);
