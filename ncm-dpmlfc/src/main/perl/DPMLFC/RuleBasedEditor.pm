...
#  %rule_constants = (
#    "LINE_FORMAT_PARAM" => 1,
#    "LINE_FORMAT_ENVVAR" => 2,
#    "LINE_FORMAT_XRDCFG" => 3,
#    "LINE_FORMAT_XRDCFG_SETENV" => 4,
#    "LINE_FORMAT_XRDCFG_SET" => 5,
#    "LINE_VALUE_AS_IS" => 0,
#    "LINE_VALUE_BOOLEAN" => 1,
#    "LINE_VALUE_HOST_LIST" => 2,
#    "LINE_VALUE_INSTANCE_PARAMS" => 3,
#    "LINE_VALUE_ARRAY" => 4,
#    "LINE_VALUE_HASH_KEYS" => 5,
#    "LINE_VALUE_STRING_HASH" => 6,
#    "LINE_VALUE_OPT_NONE" => 0,
#    "LINE_VALUE_OPT_SINGLE" => 1,
#    "LINE_FORMAT_DEFAULT" => LINE_FORMAT_PARAM,
#    "LINE_QUATTOR_COMMENT" => "\t\t# Line generated by Quattor",
#    "LINE_OPT_DEF_REMOVE_IF_UNDEF" => 0,
