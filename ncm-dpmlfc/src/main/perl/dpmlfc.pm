...
my %dav_config_rules = (
    "DiskAnon"               => "DiskAnonUser:dav;" . LINE_FORMAT_KW_VAL,
    "DiskFlags"              => "DiskFlags:dav;" . LINE_FORMAT_KW_VAL . ";" . LINE_VALUE_ARRAY,
    "NSAnon"                 => "NSAnonUser:dav;" . LINE_FORMAT_KW_VAL,
    "NSFlags"                => "NSFlags:dav;" . LINE_FORMAT_KW_VAL . ";" . LINE_VALUE_ARRAY,
    "NSMaxReplicas"          => "NSMaxReplicas:dav;" . LINE_FORMAT_KW_VAL,
    "NSRedirectPort"         => "NSRedirectPort:dav;" . LINE_FORMAT_KW_VAL . ";" . LINE_VALUE_ARRAY,
    "NSSecureRedirect"       => "NSSecureRedirect:dav;" . LINE_FORMAT_KW_VAL,
    "NSServer"               => "NSServer:dav;" . LINE_FORMAT_KW_VAL . ";" . LINE_VALUE_ARRAY,
    "NSTrustedDNS"           => "NSTrustedDNs:dav;" . LINE_FORMAT_KW_VAL . ";" . LINE_VALUE_ARRAY,
    "NSType"                 => "NSType:dav;" . LINE_FORMAT_KW_VAL,
    "SSLCertificateFile"     => "SSLCertFile:dav;" . LINE_FORMAT_KW_VAL,
    "SSLCertificateKeyFile"  => "SSLCertKey:dav;" . LINE_FORMAT_KW_VAL,
    "SSLCACertificatePath"   => "SSLCACertPath:dav;" . LINE_FORMAT_KW_VAL,
    "SSLCARevocationPath"    => "SSLCARevocationPath:dav;" . LINE_FORMAT_KW_VAL,
    "?SSLCipherSuite"        => "SSLCipherSuite:dav;" . LINE_FORMAT_KW_VAL . ";" . LINE_VALUE_ARRAY,
    "?SSLHonorCipherOrder"   => "SSLHonorCipherOrder:dav;" . LINE_FORMAT_KW_VAL,
    "SSLOptions"             => "SSLOptions:dav;" . LINE_FORMAT_KW_VAL . ";" . LINE_VALUE_ARRAY,
    "SSLProtocol"            => "SSLProtocol:dav;" . LINE_FORMAT_KW_VAL . ";" . LINE_VALUE_ARRAY,
    "SSLSessionCache"        => "SSLSessionCache:dav;" . LINE_FORMAT_KW_VAL,
    "SSLSessionCacheTimeout" => "SSLSessionCacheTimeout:dav;" . LINE_FORMAT_KW_VAL,
    "SSLVerifyClient"        => "SSLVerifyClient:dav;" . LINE_FORMAT_KW_VAL,
    "SSLVerifyDepth"         => "SSLVerifyDepth:dav;" . LINE_FORMAT_KW_VAL,
                       );
...
my %trust_config_rules = (
    "DPM PROTOCOLS" => "accessProtocols:GLOBAL;" . LINE_FORMAT_KW_VAL . ';' . LINE_VALUE_ARRAY,
    "DPM TRUST"  => "dpm->hostlist:dpns,xroot;" . LINE_FORMAT_KW_VAL . ';' . LINE_VALUE_ARRAY . ':' . LINE_OPT_VALUE_UNIQUE,
    "DPNS TRUST" => "dpns->hostlist:dpm,srmv1,srmv2,srmv22,rfio;" . LINE_FORMAT_KW_VAL . ';' . LINE_VALUE_ARRAY . ':' . LINE_OPT_VALUE_UNIQUE,
    "RFIOD TRUST"  => "rfio->hostlist:dpm,rfio;" . LINE_FORMAT_KW_VAL . ';' . LINE_VALUE_ARRAY . ':' . LINE_OPT_VALUE_UNIQUE,
    "RFIOD WTRUST" => "rfio->hostlist:dpm,rfio;" . LINE_FORMAT_KW_VAL . ';' . LINE_VALUE_ARRAY . ':' . LINE_OPT_VALUE_UNIQUE,
    "RFIOD RTRUST" => "rfio->hostlist:dpm,rfio;" . LINE_FORMAT_KW_VAL . ';' . LINE_VALUE_ARRAY . ':' . LINE_OPT_VALUE_UNIQUE,
    "RFIOD XTRUST" => "rfio->hostlist:dpm,rfio;" . LINE_FORMAT_KW_VAL . ';' . LINE_VALUE_ARRAY . ':' . LINE_OPT_VALUE_UNIQUE,
    "RFIOD FTRUST" => "rfio->hostlist:dpm,rfio;" . LINE_FORMAT_KW_VAL . ';' . LINE_VALUE_ARRAY . ':' . LINE_OPT_VALUE_UNIQUE,
    "RFIO DAEMONV3_WRMT 1" => ";" . LINE_FORMAT_KW_VAL,
    "DPM REQCLEAN"         => "dpm->requestMaxAge:dpm;" . LINE_FORMAT_KW_VAL,
);
                        ...
                        if (($role eq "dpm") || ($role eq "lfc")) {
                            if ($role eq "lfc") {
                                if (exists($dpmlfc_config->{"dpns"})) {
                                    $self->error(
                                          "LFC server and DPNS server cannot be run on the same node. Skipping LFC configuration.");
                                    return 0;
                                }
                            }
                        }
...
sub createDbConfigFile
{
    ...
    my $config_fh = CAF::FileWriter->new(
                                         $config_options->{"dbconfigfile"} . $config_prod_ext,
    ...
    if ($db_info_user) {
        my $info_fh = CAF::FileWriter->new(
                                           $db_info_file . $config_prod_ext,
                                           backup => $config_bck_ext,
                                           owner  => $gip_user,
                                           group  => $daemon_group,
                                           mode   => oct($dbconfigmode),
