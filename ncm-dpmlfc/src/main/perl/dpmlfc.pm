...
sub xrootdSpecificConfig () {
  ...
  # Build authz.cf
  my $exported_vo_path = $self->NSGetRoot();
  if ( $xrootd_exported_vo ) {
    $exported_vo_path .= '/'.$xrootd_exported_vo;
  } else {
  ...
  my $xroot_authz_conf_contents = "Configuration file for xroot authz generated by quattor - DO NOT EDIT.\n\n" .
                                  ...
                                  "EXPORT PATH:".$exported_vo_path." VO:*     ACCESS:ALLOW CERT:*\n\n";
  if ( $xroot_headnode ) {
  ...
  for my $daemon ('oldb','xrootd') {
    ...
    if ( !-x $daemon ) {
      $self->warn("$daemon missing or not executable. Check your DPM installation.");
    }
