...
my %trust_config_rules = (
    ...
    "DPM TRUST"  => "dpm->hostlist:dpns,xroot;" . LINE_FORMAT_KW_VAL . ';' . LINE_VALUE_ARRAY . ':' . LINE_VALUE_OPT_UNIQUE,
    "DPNS TRUST" => "dpns->hostlist:dpm,srmv1,srmv2,srmv22,rfio;" . LINE_FORMAT_KW_VAL . ';' . LINE_VALUE_ARRAY . ':' . LINE_VALUE_OPT_UNIQUE,
    "RFIOD TRUST"  => "rfio->hostlist:dpm,rfio;" . LINE_FORMAT_KW_VAL . ';' . LINE_VALUE_ARRAY . ':' . LINE_VALUE_OPT_UNIQUE,
    "RFIOD WTRUST" => "rfio->hostlist:dpm,rfio;" . LINE_FORMAT_KW_VAL . ';' . LINE_VALUE_ARRAY . ':' . LINE_VALUE_OPT_UNIQUE,
    "RFIOD RTRUST" => "rfio->hostlist:dpm,rfio;" . LINE_FORMAT_KW_VAL . ';' . LINE_VALUE_ARRAY . ':' . LINE_VALUE_OPT_UNIQUE,
    "RFIOD XTRUST" => "rfio->hostlist:dpm,rfio;" . LINE_FORMAT_KW_VAL . ';' . LINE_VALUE_ARRAY . ':' . LINE_VALUE_OPT_UNIQUE,
    "RFIOD FTRUST" => "rfio->hostlist:dpm,rfio;" . LINE_FORMAT_KW_VAL . ';' . LINE_VALUE_ARRAY . ':' . LINE_VALUE_OPT_UNIQUE,
