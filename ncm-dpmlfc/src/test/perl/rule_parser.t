...
#
DPNS TRUST node1.example.com node2.example.com
';
...
my %rules_multi_cond_sets = (
        "DPNS TRUST" => "dpm->host:dpns,srmv1;".LINE_FORMAT_XRDCFG,
);
...
my $dpm_options = {dpm => {allowCoreDump => 1,
                   ...
                   dpns => {host => 'node1.example.com'},
                   srmv1 => {host => 'node2.example.com'}};
...
$changes = NCM::Component::dpmlfc::RuleBasedEditor->updateConfigFile($DPM_SHIFT_CONF_FILE,
                                                                     \%rules_no_rule,
                                                                     $dpm_options);
