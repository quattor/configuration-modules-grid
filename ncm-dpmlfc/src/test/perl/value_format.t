...
$formatted_value = NCM::Component::DPMLFC::RuleBasedEditor->formatAttributeValue(0,
                                                                                 LINE_FORMAT_XRDCFG,
                                                                                 LINE_VALUE_BOOLEAN);
is($formatted_value, $FALSE, "Boolean (false) correctly formatted");
$formatted_value = NCM::Component::DPMLFC::RuleBasedEditor->formatAttributeValue(1,
                                                                                 LINE_FORMAT_XRDCFG,
                                                                                 LINE_VALUE_BOOLEAN);
...
$formatted_value = NCM::Component::DPMLFC::RuleBasedEditor->formatAttributeValue($AS_IS_VALUE,
                                                                                 LINE_FORMAT_XRDCFG,
                                                                                 LINE_VALUE_AS_IS);
...
$formatted_value = NCM::Component::DPMLFC::RuleBasedEditor->formatAttributeValue($AS_IS_VALUE_QUOTED,
                                                                                 LINE_FORMAT_XRDCFG,
                                                                                 LINE_VALUE_AS_IS);
...
$formatted_value = NCM::Component::DPMLFC::RuleBasedEditor->formatAttributeValue($EMPTY_VALUE,
                                                                                 LINE_FORMAT_XRDCFG,
                                                                                 LINE_VALUE_AS_IS);
...
$formatted_value = NCM::Component::DPMLFC::RuleBasedEditor->formatAttributeValue(\%INSTANCE_PARAMS,
                                                                                 LINE_FORMAT_XRDCFG,
                                                                                 LINE_VALUE_INSTANCE_PARAMS);
...
$formatted_value = NCM::Component::DPMLFC::RuleBasedEditor->formatAttributeValue(\@TEST_ARRAY,
                                                                                 LINE_FORMAT_XRDCFG,
                                                                                 LINE_VALUE_ARRAY);
