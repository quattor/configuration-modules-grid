...
Part of the configuration information used by this componenent is coming from /system/vo/VONAME/services. EDG RB
...
=head2 /software/components/ncm-wmsclient/MW_VARIANT/active

Set to true to configure this WMS/RB variant.

Default : true (for a present variant).

=head2 /software/components/ncm-wmsclient/MW_VARIANT/basedir
...
=head2 /software/components/ncm-wmsclient/MW_VARIANT/defaultAttrs
...
=head2 VO specific configuration
...
=head3 /system/vo/*/name

The official name of the VO.

Default : none.

=head3 services/lbhosts (required)
...
=head3 services/wmproxies ('wmproxy' only, required)
...
=head3 services/myproxy (optional)

The myproxy server to use for this VO.

Default : none.

=head3 services/hlr (optional)
