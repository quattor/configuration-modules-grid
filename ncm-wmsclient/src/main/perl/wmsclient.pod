...
=head2 /software/components/wmsclient/MW_VARIANT/active

Set to true to configure this WMS/RB variant.

Default : true (for a present variant).

=head2 /software/components/wmsclient/MW_VARIANT/basedir
...
=head2 /software/components/wmsclient/MW_VARIANT/defaultAttrs
