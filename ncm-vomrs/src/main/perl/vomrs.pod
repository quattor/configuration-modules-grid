...
yaim: NCM component for configuring VOMRS
...
=head2 /software/comonents/vomrs/confdir (string)
...
=head2 /software/componets/vomrs/<vo>/vomrs/<KEY>/<VALUE>
Will populate the VOMRS Configuration section with

  <KEY> = <VALUE>

=head2 /software/componets/vomrs/<vo>/voinfo/<KEY>/<VALUE>
Will populate the VO Related information 

  <KEY> = <VALUE>

=head2 /software/componets/vomrs/<vo>/gridorg/<KEY>/<VALUE>
Will populate the Grid Organisation section with

  <KEY> = <VALUE>

=head2 /software/componets/vomrs/<vo>/tomcat/<KEY>/<VALUE>
Will populate the tomcat related section with

  <KEY> = <VALUE>

=head2 /software/componets/vomrs/<vo>/cacert/<KEY>/<VALUE>
Will populate the CA and certificate section of the configuration file with

  <KEY> = <VALUE>

=head2 /software/componets/vomrs/<vo>/vomem/<KEY>/<VALUE>
Will populate the VO Membership portion of the configuration files with

  <KEY> = <VALUE>

=head2 /software/componets/vomrs/<vo>/event/<KEY>/<VALUE>
Will populate the Event notification of the configuration file with.

  <KEY> = <VALUE>

=head2 /software/componets/vomrs/<vo>/sync/<KEY>/<VALUE>
Will populate the voms syncronisation part of the configuration with

  <KEY> = <VALUE>

=head2 /software/componets/vomrs/<vo>/db/<KEY>/<VALUE>
Will populate the database configuration part of the configuration.

  <KEY> = <VALUE>

=head2 /software/componets/vomrs/<vo>/lcg/<KEY>/<VALUE>
