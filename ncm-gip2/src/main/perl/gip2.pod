...
=head3 LDIF confFile : string (optional)
...
=head3 LDIF template : string (deprecated)
...
=head3 LDIF entries : nlist (optional)
...
=head3 LDIF staticInfoCmd : string (optional)
...
=head2 /software/components/gip2/ldifConfEntries : nlist (optional)
...
=head2 /software/components/gip2/staticInfoCmd : string (optional)
